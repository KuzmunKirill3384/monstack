export const config = {
  ...
  REFRESH_MS: Number(process.env.TUI_REFRESH_MS) || 2000,
  PROCESSES_REFRESH_MS: Number(process.env.TUI_PROCESSES_REFRESH_MS) || 800,
  ALERTS_REFRESH_MS: Number(process.env.TUI_ALERTS_REFRESH_MS) || 5000,
